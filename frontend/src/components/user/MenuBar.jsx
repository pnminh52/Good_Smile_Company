...
const MenuBar = ({ upcomingAlert }) => {
  ...
  return (
    <div>
      <div className=" block lg:hidden h-16 flex items-center justify-center border-t border-gray-300 relative">
        <ul className="flex items-center gap-6">
          ...
          <li
            ...
            className="flex items-center flex-col cursor-pointer gap-0 text-sm relative"
          >
          ...
          {/* Contact */}
        <Link to={"support/customer-support"}>
          <li
                    className="flex items-center flex-col cursor-pointer gap-0 text-sm"
                  >
